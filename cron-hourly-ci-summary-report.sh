...
cron_log_file="/tmp/cron-hourly-ci-summary-report-$(timestamp).txt"
...
python ci-summary-report.py -f /apps/dftjenkins/JENKINS_HOME/jobs -sd 'today' -ct 'hourly' -p 'Snz1ylE0pxf!' >  $cron_log_file 2>&1
